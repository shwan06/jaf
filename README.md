...
**Optional GPTZero check:** the Tutor toolbar has a "🔍 GPTZero" toggle that,
once you paste a free key from [gptzero.me/developers](https://gptzero.me/developers),
shows a confidence score under each reply. It's mostly a demo — every Tutor
reply is AI-generated by construction — but it's a ready-made hook if you
want to run other text through GPTZero later. Same bring-your-own-key,
browser-only pattern as the providers above; off by default.
